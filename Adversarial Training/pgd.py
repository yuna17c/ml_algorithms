...
if not os.path.exists('3d_results'):
    os.mkdir('3d_results')
...
def display_img(imgs, num, labels):
    ...
    for i in range(5):
        ...
        save_image(img[rand_j[i]],
                   '3d_results/' + str(num) + str(i) + '_' + str(label)  + '.png')
...
# PGD training and PGD attack (part d)
print("------\nPGD")
